 ...
 * Description: Apenas um simples plugin de testemunho
 * Version: 1.0
 * Requires at least: 5.6
 * Requires PHP: 7.0
 * Author: Jonathan Mathues da Silva
 * Author URI: https://pragmatico.dev/
...
if (!class_exists('MV_Testimonials')) {
    ...
    class MV_Testimonials
    {
        ...
        public function __construct()
        {
            ...
            $MVTestimonialWidget = new MV_Testimonials_Widget();
        }
